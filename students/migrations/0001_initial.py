    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_type', models.CharField(choices=[('Leader', 'Cohort Leader'), ('Vice', 'Vice Student President'), ('President', 'Student President'), ('Secretary', 'Secretary'), ('Student', 'Student')], default='Student', max_length=9)),
